...
public class BlockMarbleWall extends Block implements IHasModel {
    public static final PropertyBool UP = PropertyBool.create("up");
    public static final PropertyBool NORTH = PropertyBool.create("north");
    public static final PropertyBool EAST = PropertyBool.create("east");
    public static final PropertyBool SOUTH = PropertyBool.create("south");
    public static final PropertyBool WEST = PropertyBool.create("west");
    public static final PropertyEnum<BlockMarbleWall.EnumType> VARIANT = PropertyEnum.<BlockMarbleWall.EnumType>create("variant", BlockMarbleWall.EnumType.class);
    ...
    public BlockMarbleWall(String name, Material material, MapColor color)
    {
        super(material, color);
        setRegistryName(name);
        setTranslationKey(name);
        setDefaultState(this.blockState.getBaseState().withProperty(UP, Boolean.valueOf(false)).withProperty(NORTH, Boolean.valueOf(false)).withProperty(EAST, Boolean.valueOf(false)).withProperty(SOUTH, Boolean.valueOf(false)).withProperty(WEST, Boolean.valueOf(false)).withProperty(VARIANT, BlockMarbleWall.EnumType.NORMAL));
        setHardness(1.0F);
        setResistance(3.0F / 3.0F);
    ...
    {
        return I18n.translateToLocal(this.getTranslationKey() + "." + BlockMarbleWall.EnumType.NORMAL.getTranslationKey() + ".name");
    }
    ...
    {
        return ((BlockMarbleWall.EnumType)state.getValue(VARIANT)).getMetadata();
    }
    ...
    {
        return this.getDefaultState().withProperty(VARIANT, BlockMarbleWall.EnumType.byMetadata(meta));
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final BlockMarbleWall.EnumType[] META_LOOKUP = new BlockMarbleWall.EnumType[values().length];
        ...
        public static BlockMarbleWall.EnumType byMetadata(int meta)
        {
        ...
        static
        {
            for (BlockMarbleWall.EnumType blockwall$enumtype : values())
            {

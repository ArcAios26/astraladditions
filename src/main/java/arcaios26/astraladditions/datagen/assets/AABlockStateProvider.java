...
public class AABlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        wallBlock(BlocksAA.STARMETAL_WALL, new ResourceLocation(AstralSorcery.MODID, "block/starmetal"));
        ...
        fenceBlock(BlocksAA.STARMETAL_FENCE, new ResourceLocation(AstralSorcery.MODID, "block/starmetal"));
        ...
        fenceGateBlock(BlocksAA.STARMETAL_FENCE_GATE, new ResourceLocation(AstralSorcery.MODID, "block/starmetal"));
    }
}
